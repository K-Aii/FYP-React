...
for (b = 0; b < w.length; b++) p.prototype["get" + E(w[b])] = P(w[b]), p.prototype["set" + E(w[b])] = /* @__PURE__ */ function(e) {
  return function(t) {
    this[e] = !!t;
  };
}(w[b]);
var b;
for (v = 0; v < N.length; v++) p.prototype["get" + E(N[v])] = P(N[v]), p.prototype["set" + E(N[v])] = /* @__PURE__ */ function(e) {
  return function(t) {
...
var v;
for (h = 0; h < _.length; h++) p.prototype["get" + E(_[h])] = P(_[h]), p.prototype["set" + E(_[h])] = /* @__PURE__ */ function(e) {
  return function(t) {
    this[e] = String(t);
  };
}(_[h]);
...
var L;
async function T() {
  if (!g || (z = (await import("./node_url-VMBKG23O.js")).default, H = await import("./node_fs-23V4EMJG.js"), L = await import("./promises-K5HYVQP3.js"), V = (await import("./node_vm-JYILYGKA.js")).default, D = await import("./node_path-NZFCBJUN.js"), U = D.sep, typeof I < "u")) return;
...
c(q, "loadBinaryFile");
var F;
if ($) F = c(async (e) => await import(e), "loadScript");
else if (j) F = c(async (e) => {
  try {
...
function Y(e) {
  let t = e.FS, o = e.FS.filesystems.MEMFS, r = e.PATH, a = { DIR_MODE: 16895, FILE_MODE: 33279, mount: function(n) {
    ...
    for (; d.length; ) {
      ...
      t.isDir(m.mode) && d.push.apply(d, t.readdir(u).filter(s).map(l(u))), i[u] = { timestamp: m.mtime, mode: m.mode };
    }
    ...
    Object.keys(i.entries).forEach(function(f) {
      let y = i.entries[f], S = s.entries[f];
...
function G(e) {
  ...
  }, print: e.stdout, printErr: e.stderr, arguments: e.args, API: { config: e }, locateFile: (o) => e.indexURL + o, instantiateWasm: ye(e.indexURL) };
  return t;
}
c(G, "createSettings");
function ue(e) {
...
function ye(e) {
  let { binary: t, response: o } = R(e + "pyodide.asm.wasm");
  return function(r, a) {
